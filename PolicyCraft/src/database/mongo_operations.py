...
class MongoOperations:
    ...
    def load_sample_policies_for_user(self, user_id: int) -> bool:
        ...
        try:
            ...
            # Use relative path from current file location instead of hardcoded absolute path
            # This ensures the application works on any system/server
            dataset_path = Path(__file__).resolve().parents[2] / "data" / "policies" / "clean_dataset"
